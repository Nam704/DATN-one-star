                                    ...
                                    <table class="table table-condensed mb-0 border-top">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="ng-binding">{{ $user->phone ? $user->phone : "" }}</td>
                                            </tr>
                                ...
                                <div class="timeline-2">
                                    ...
                                    <div class="time-item">
                                        <div class="item-info ms-3 mb-3">
                                            ...
                                            <img src="assets/images/small/small-2.jpg" alt="" height="40" width="60"
                                                class="rounded-1">
                                            <img src="assets/images/small/small-1.jpg" alt="" height="40" width="60"
                                                class="rounded-1">
                                        </div>
                                    </div>
