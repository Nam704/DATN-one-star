...
class ShopController extends Controller
{
    public function shop(Request $request)
    {
        ...
        return view('client.shop', compact('categories', 'brands', 'products', 'maxPrice'));
    }
    ...
    public function filter(Request $request)
    {
        ...
        $productsHtml = view('client.shop.product-list', compact('products'))->render();
        $paginationHtml = view('client.shop.pagination', compact('products'))->render();
