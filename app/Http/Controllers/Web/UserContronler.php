...
class UserContronler extends Controller
{
    ...
    public function chart_user($id)
    {
        ...
        return view('admin.user.chart_user', compact('user', 'order', 'totalSpent', 'totalOrders', 'topPurchasedProducts', 'maxOrder', 'minOrder', 'totalProductsBought', 'latestOrder', 'customerRank'));
    }
    ...
    {
        $tf = $request->input('timeframe','daily');
        ...
        switch($tf) {
            ...
            case 'weekly':
                ...
                $daily = User::whereBetween('created_at',[$start,$end])
            ...
            case 'yearly':
                ...
                $monthly = User::whereBetween('created_at',[$start,$end])
