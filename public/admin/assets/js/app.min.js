...
!(function (o) {
    function e() {
        ...
        _toConsumableArray(
            ...
            _toConsumableArray(document.querySelectorAll(".offcanvas")).map(
                function (e) {
    ...
    function t() {
        ...
        o(".side-nav").length &&
            ...
            o(".side-nav li [data-bs-toggle='collapse']").on(
                "click",
                function (e) {
                    return !1;
                }
            ...
            setTimeout(function () {
                ...
                null != t &&
                    ...
                    e &&
                        ...
                        (function e() {
                            var t = c((r += 20), o, i, a);
                            (n.scrollTop = t), r < a && setTimeout(e, 20);
                        })()));
            }, 200));
    }
    var n, a, i, r;
    e(),
        ...
        jQuery().timepicker &&
            ((r = {
                showSeconds: !0,
                icons: { up: "mdi-chevron-up", down: "mdi-chevron-down" },
            }),
                ...
                value: function () {
                    var n = this,
                        e =
                            ...
                            document
                                .querySelectorAll(
                                    "input[name=data-layout-position]"
                                )
                                .forEach(function (t) {
                                    t.addEventListener("change", function (e) {
