(function ($) {
    ...
    jQuery(window).on("load", function () {
        $(".instagram-wrap").slick({
            ...
            arrows: true,
            prevArrow:
                '<button class="prev_arrow"><i class="ion-ios-arrow-thin-left"></i></button>',
            nextArrow:
                '<button class="next_arrow"><i class="ion-ios-arrow-thin-right"></i></button>',
            responsive: [
                {
                    breakpoint: 300,
                    settings: {
    ...
    var activeId = $("#instafeed"),
        myTemplate =
            '<div class="col"><div class="instagram-item"><a href="{{link}}" target="_blank" id="{{id}}"><img src="{{image}}" /></a><div class="instagram-hvr-content"><span class="totalcomments"><i class="fa fa-comment"></i>{{comments}}</span><span class="tottallikes"><i class="fa fa-heart"></i>{{likes}}</span></div></div></div>';
