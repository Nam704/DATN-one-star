...
@section('content')
<h4 class="fs-20">Quên mật khẩu?</h4>
<p class="text-muted mb-3">Nhập email của bạn và chúng tôi sẽ gửi email hướng dẫn đổi mật khẩu cho bạn.</p>
<div>
    @if (session('success'))
...
<form action="{{ route('auth.sendPasswordResetEmail') }}" method="POST">
    ...
    <div class="mb-0 text-start">
        <button class="btn btn-soft-primary w-100" type="submit"><i class="ri-loop-left-line me-1 fw-bold"></i> <span
                class="fw-bold">Đặt lại mật khẩu</span> </button>
    </div>
</form>
@endsection
...
<div class="row">
    <div class="col-12 text-center">
        <p class="text-dark-emphasis">Quay lại <a href="{{ route('auth.getFormLogin') }}"
