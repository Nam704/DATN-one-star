...
<p class="text-muted mb-3">Nhập email và mật khẩu của bạn để truy cập tài khoản
</p>
<div>
...
<div class="row">
    <div class="col-12 text-center">
        <p class="text-dark-emphasis">Bạn không có tài khoản?<a href="{{ route('auth.getFormRegister') }}"
