...
<p class="text-muted mb-3">Nhập địa chỉ email và mật khẩu của bạn để truy cập
tài khoản.
</p>
<div>
...
<form action="{{ route('auth.login') }}" method="POST">
    ...
    <div class="mb-3">
        <a href="{{ route('auth.getFormForgotPassword') }}" class="text-muted float-end"><small>Quên mật khẩu</small></a>
...
<div class="row">
    <div class="col-12 text-center">
        <p class="text-dark-emphasis">Bạn có tài khoản chưa? <a href="{{ route('auth.getFormRegister') }}"
                class="text-dark fw-bold ms-1 link-offset-3 text-decoration-underline"><b>Đăng ký</b></a>
        </p>
    </div> <!-- end col -->
</div>
@endsection