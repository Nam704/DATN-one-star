        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="profile-user-box">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="profile-user-img"><img src="{{ asset('storage/' . $user->profile_image) }}"
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex justify-content-end align-items-center gap-2">
                                ...
                                <a class="btn btn-soft-info" href="#"> <i
                                        class="ri-check-double-fill fs-18 me-1 lh-1"></i>
                                    Following</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="timeline-2">
                                        <div class="time-item">
                                            <div class="item-info ms-3 mb-3">
                                                ...
                                                <img src="" alt="" height="40" width="60"
                                                    class="rounded-1">
                                                <img src="" alt="" height="40" width="60"
                                                    class="rounded-1">
                                            </div>
                                            ...
                                            <div class="row row-cols-sm-2 row-cols-1">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" value="{{ $user->phone ? $user->phone : '' }}"
                                                        name="phone" id="phone"
                                                        placeholder="{{ $user->phone ? $user->phone : ' Enter your phone' }}"
                                                        class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="ward" class="form-select" id="ward">
                                                                <option value="" {{ old('ward') ? 'selected' : '' }}>
                                                                    Chọn
                                                                    phường
                                                                </option>
                                                            </select>
