...
<p class="text-muted mb-3">Nhập email, mật khẩu để đăng ký tài khoản mới.</p>
<div>
    @if ($errors->any())
...
<form action="{{ route('auth.register') }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" id="namee" name="name" placeholder="Nhập tên người dùng" required="">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <div class="form-check">
            ...
            <label class="form-check-label" for="checkbox-signup">Tôi chấp nhận Điều khoản & Điều kiện</label>
        </div>
    </div>
    <div class="mb-0 d-grid text-center">
        <button class="btn btn-primary fw-semibold" type="submit">Đăng ký</button>
    </div>

    <div class="text-center mt-4">
        <p class="text-muted fs-16">Đăng nhập với</p>
...
<div class="row">
    <div class="col-12 text-center">
        <p class="text-dark-emphasis">Bạn đã có tài khoản? <a href="{{ route('auth.getFormLogin') }}"
                class="text-dark fw-bold ms-1 link-offset-3 text-decoration-underline"><b>Đăng nhập</b></a>
        </p>
    </div> <!-- end col -->
</div>
@endsection
