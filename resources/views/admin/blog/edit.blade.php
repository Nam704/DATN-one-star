    ...
    <div>
        <form id="blog-form" action="{{ route('admin.blogs.update', $blog->id) }}" method="post"
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <img src="{{ asset($blog->thumbnail) }}" alt="img" height="300px" width="200px" class="img-fluid">
                            </div>
                            @endif
                            @error('thumbnail')
                            <div class="text-danger">{{ $message }}</div>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-warning mr-2 me-2" onclick="setStatus('draft')">Lưu bản
                    nháp</button>
