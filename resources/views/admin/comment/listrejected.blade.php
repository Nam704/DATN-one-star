        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title">Danh sách bình luận từ chối</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('admin.comments.approve', $comment->id) }}" method="POST" class="d-inline me-1" onclick="return confirm('Bạn có muốn duyệt lại không?')">
                                                    @csrf
                                                    <button type="submit" class="btn btn-sm btn-warning">Duyệt lại</button>
                                                </form>
