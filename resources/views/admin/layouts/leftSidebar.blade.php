        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarPagesAuth">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{ route('admin.users.index') }}">List admin</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.users.listemployee') }}">List employee</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.users.listuser') }}">List user</a>
                        </li>
                        <li>
                            <a href="{{ route('admin.users.listtkkhoa') }}">List tài khoản khóa</a>
                        </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarMultiLevel">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{route('admin.vouchers.listVoucher')}}">List</a>
                        </li>
                    </ul>
                </div>
            </li>
