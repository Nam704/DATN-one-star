...
<script>
    ...
    $(document).ready(function() {
        ...
        var todayStr = today.toISOString().split('T')[0]; //thêm
        ...
        $('#fromDate').attr('max', todayStr); //thêm
        $('#toDate').attr('max', todayStr); //thêm
        $('#fromDateV2').attr('max', todayStr); //thêm
        $('#toDateV2').attr('max', todayStr); //thêm
