        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (!response || response.length === 0) {
                    ...
                    ctxV3.fillText('Không có sản phẩm nào', ctxV3.canvas.width / 2, ctxV3.canvas.height / 2);
                    return;
                }
                ...
                // Auto set canvas height
                const canvas = document.getElementById('myChartProductView');
                canvas.height = response.length * 40; // mỗi sản phẩm chiếm 40px chiều cao
