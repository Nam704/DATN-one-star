                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="password" class="form-control" id="password" name="password" placeholder="Nhập mật khẩu" value="{{ $user->password }}">
                            @error('password')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" id="province" name="province_id">
                                    <option value=" $user->address->province">-- Chọn Tỉnh --</option>
                                </select>
                                @error('province_id')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control" name="address_detail" id="address_detail" placeholder="Số nhà, tên đường..." value="{{  $user->address->address_detail }}">
