            ...
            <form action="{{ route('admin.vouchers.addPostVoucher')}}" method="post" class="form">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg shadow-sm"  placeholder="Nhập tên voucher..." value="{{ old('name') }}">
                        @error('name') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="code" class="form-label text-dark">Mã Voucher</label>
                        <input type="text" name="code" class="form-control form-control-lg shadow-sm" placeholder="Nhập mã voucher..." value="{{ old('code') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="form-control form-control-lg shadow-sm" rows="3" placeholder="Nhập mô tả voucher...">{{ old('description') }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" step="0.01" name="discount_amount" class="form-control form-control-lg shadow-sm" placeholder="Nhập giá trị giảm..." value="{{ old('discount_amount') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" name="quantity" class="form-control form-control-lg shadow-sm" placeholder="Nhập số lượng..." value="{{ old('quantity') }}">
                        @error('quantity') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="user_limit" class="form-label text-dark">Số lần tối đa cho mỗi user</label>
                        <input type="number" name="user_limit" class="form-control form-control-lg shadow-sm" placeholder="Nhập số lần..." value="{{ old('user_limit') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="datetime-local" name="start_date" class="form-control form-control-lg shadow-sm" value="{{ old('start_date') }}">
                        @error('start_date') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="end_date" class="form-label text-dark">Thời gian kết thúc</label>
                        <input type="datetime-local" name="end_date" class="form-control form-control-lg shadow-sm" value="{{ old('end_date') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" step="0.01" name="min_amount" class="form-control form-control-lg shadow-sm" placeholder="Nhập số tiền tối thiểu..." value="{{ old('min_amount') }}">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="number" step="0.01" name="max_discount_amount" class="form-control form-control-lg shadow-sm" placeholder="Nhập giá trị tối đa..." value="{{ old('max_discount_amount') }}">
