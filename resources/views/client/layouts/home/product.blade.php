...
<!--featured categories area start (chưa làm vội)-->
{{-- @include('client.layouts.home.featured-categories') --}}
<!--featured categories area end-->

<!--small product body part area start (chưa làm vội)-->
{{-- @include('client.layouts.home.body-part') --}}
