    ...
    <section class="slider_section slider_two mb-50">
        <div class="slider_area owl-carousel">
            <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('client/assets/img/slider/slider10.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('client/assets/img/slider/slider11.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="{{ asset('client/assets/img/slider/slider12.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content">
                    ...
                    <div class="banner_container">
                        <div class="single_banner">
                            <div class="banner_thumb">
                                <a href="shop.html"><img src="{{ asset('client/assets/img/bg/banner3.jpg') }}" alt=""></a>
                        ...
                        <div class="single_banner">
                            <div class="banner_thumb">
                                <a href="shop.html"><img src="{{ asset('client/assets/img/bg/banner4.jpg') }}" alt="banner"></a>
                                <div class="banner_text">
                                    <h3>All - New</h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_title">
                        <h2><span> <strong>Popular</strong>Products</span></h2>
                    </div>
                    {{-- <div class="product_carousel product_column4 owl-carousel">
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                <a class="primary_img" href="product-details.html"><img src="{{ asset('client/assets/img/product/product19.jpg')}}" alt=""></a>
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('client/assets/img/product/product11.jpg')}}" alt=""></a>
                    ...
                    <div class="product_carousel product_column4 owl-carousel">
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                ...
                                <div class="label_product">
                                    @if($product->variants->first() && $product->variants->first()->price)
                                ...
                                <div class="product_footer d-flex align-items-center">
                                    <div class="price_box">
                                        @if($product->variants->first())
                                            <span class="current_price">{{ number_format($product->variants->first()->price) }}đ</span>
                                        @endif
                                    </div>
                                    <div class="add_to_cart">
                                        <a href="cart.html" title="add to cart"><span class="lnr lnr-cart"></span></a>
                    ...
                    <div class="product_carousel featured_four  product_column5 owl-carousel">
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('client/assets/img/featured/featured.jpg') }}" alt=""></a>
                            </div>
                        ...
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('client/assets/img/featured/featured1.jpg') }}" alt=""></a>
                            </div>
                            <div class="featured_content">
                        ...
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('client/assets/img/featured/featured2.jpg') }}" alt=""></a>
                            </div>
                            <div class="featured_content">
                        ...
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('client/assets/img/featured/featured3.jpg') }}" alt=""></a>
                            </div>
                            <div class="featured_content">
                        ...
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('assets/img/featured/featured3.jpg')}}" alt=""></a>
                            </div>
                            <div class="featured_content">
                                <h3 class="product_name"><a href="#">Body Parts</a></h3>
                                <div class="sub_featured">
                        ...
                        <div class="single_featured">
                            <div class="featured_thumb">
                                <a href="#"><img src="{{ asset('assets/img/featured/featured5.jpg')}}" alt=""></a>
                            </div>
                            <div class="featured_content">
                                <h3 class="product_name"><a href="#">Brake Parts</a></h3>
                                <div class="sub_featured">
                    ...
                    <div class="product_carousel product_column5 owl-carousel">
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                ...
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/img/product/product6.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-57%</span>
                                </div>
                        ...
                        <div class="single_product">
                            ...
                            <div class="product_thumb">
                                ...
                                <a class="secondary_img" href="product-details.html"><img src="{{ asset('assets/img/product/product8.jpg')}}" alt=""></a>
                                <div class="label_product">
                                    <span class="label_sale">-47%</span>
                                </div>
