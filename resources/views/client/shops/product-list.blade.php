    ...
    <div class="single_product">
        ...
        <div class="product_thumb">
            ...
            <a class="secondary_img" href="product-details.html">
                <img src="{{ asset($product->image_primary) }}"> </a>
            ...
            <div class="action_links">
                <ul>
                    ...
                    <li class="compare"><a href="compare.html" title="compare"><span class="lnr lnr-sync"></span></a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="product_footer d-flex align-items-center">
                    <div class="price_box">
                        <span class="current_price">
                            ...
                            $product->variants->first()->importDetails->isNotEmpty())
                            <span class="current_price">
                                {{ number_format($product->variants->first()->importDetails->first()->expected_price, 0,
                                ',', '.') }}đ
                            </span>
                            @else
