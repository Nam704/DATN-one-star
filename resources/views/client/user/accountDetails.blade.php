                    ...
                    <div class="row row-cols-sm-2 row-cols-1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="" name="old_password"
                                placeholder="Nhập lại mật khẩu cũ" id="web-url" class="form-control">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" placeholder="Nhập mật khẩu mới" id="new_password"
                                class="form-control" name="new_password">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="new_password_confirmation">Nhập lại mật khẩu</label>
                            <input type="password" placeholder="Nhập lại mật khẩu" name="new_password_confirmation"
