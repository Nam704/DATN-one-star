                    ...
                    <div class="row row-cols-sm-2 row-cols-1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="" name="old_password"
                                placeholder="Enter your old password" id="web-url" class="form-control">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="new_password_confirmation">Re-Password</label>
                            <input type="password" placeholder="8 - 15 Characters" name="new_password_confirmation"
