...
Route::prefix('/')->name('client.')->group(function () {
    Route::prefix('users')->name('user.')->group(function () {
        // Định nghĩa route cho users tại đây
    });

    Route::prefix('products')->name('product.')->group(function () {
        Route::get('checkout/', [ProductController::class, 'checkoutProduct'])->name('checkoutProduct');

        Route::get('detail/', [ProductController::class, 'productDetail'])->name('detail');
    });
