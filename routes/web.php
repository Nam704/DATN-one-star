...
Route::prefix('admin')->name('admin.')->middleware(['role:admin,employee'])->group(
    function () {
        ...
        Route::controller(DashboardController::class)->group(function () {
            ...
            Route::get('/daily-statistics-dashboard', [DashboardController::class, 'dailyStatistics_Dashboard'])->name('dailyStatistics_Dashboard');                Route::get('/weekly-order-stats', [DashboardController::class, 'weeklyOrderStats'])->name('weeklyOrderStats');
            Route::get('/topUserPurchases', [DashboardController::class, 'topUserPurchases'])->name('topUserPurchases');
        });
